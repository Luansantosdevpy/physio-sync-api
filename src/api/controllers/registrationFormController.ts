...
export default class RegistrationFormController {
  ...
  public findAll = async (
    ...
    try {
      Logger.debug(
        'RegistrationFormController - findAll - call subcategoryService.findall'
      );
  ...
  public create = async (req: Request, res: Response): Promise<Response> => {
    try {
      Logger.debug('RegistrationFormController - create - validate payload');
      ...
      Logger.debug('RegistrationFormController - create - call subcategoryService.create');
      const user = await this.subcategoryService.create(req.body);

      return res.status(HttpStatusCode.Ok).json({ data: user });
    } catch (error) {
      Logger.error(`RegistrationFormController - create - error: ${error}`);
  ...
  public findById = async (
    ...
    try {
      Logger.debug('RegistrationFormController - find - validate id');
      ...
      Logger.debug('RegistrationFormController - find - call subcategoryService.find');
      const category = await this.subcategoryService.findById(id);

      return response.status(HttpStatusCode.Ok).json({ data: category });
    } catch (error) {
      Logger.error(`RegistrationFormController - find - error: ${error}`);
  ...
  public update = async (
    ...
    try {
      Logger.debug('RegistrationFormController - update - validate payload');
      const errors = validationResult(request);
      ...
      Logger.debug('RegistrationFormController - update - call subcategoryService.update');
      await this.subcategoryService.update(id, request.body);

      return response.status(HttpStatusCode.NoContent).send();
    } catch (error) {
      Logger.error(`RegistrationFormController - update - error: ${error}`);
  ...
  public delete = async (
    ...
    try {
      Logger.debug('RegistrationFormController - delete - validate id');
      const errors = validationResult(request);
      ...
      Logger.debug('RegistrationFormController - delete - call subcategoryService.delete');
      await this.subcategoryService.delete(id);

      return response.status(HttpStatusCode.NoContent).send();
    } catch (error) {
      Logger.error(`RegistrationFormController - delete - error: ${error}`);
